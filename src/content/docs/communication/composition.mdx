...
- [React docs: Importing and Exporting Components](https://react.dev/learn/importing-and-exporting-components) by React Team — organizing components and composition patterns
