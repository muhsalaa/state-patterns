...
- [React docs: Sharing State Between Components](https://react.dev/learn/sharing-state-between-components) by React Team — official guide for sharing state by lifting
